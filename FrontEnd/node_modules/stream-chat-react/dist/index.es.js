    ...
    value: function render() {
      ...
      if (type === 'image') {
        ...
        if (a.actions && a.actions.length) {
          ...
          results.push( /*#__PURE__*/React__default.createElement(Card, _extends({}, a, {
            key: "key-card-".concat(a.id)
          })));
        }
      }
...
var LoadingErrorIndicator = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(LoadingErrorIndicator, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", null, "Error: ", this.props.error.message);
    }
  }]);
...
var MessageActionsBox = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(MessageActionsBox, [{
    ...
    value: function render() {
      ...
      }, "Flag")), messageActions.indexOf(MESSAGE_ACTIONS.mute) > -1 && /*#__PURE__*/React__default.createElement("button", {
        onClick: handleMute
      }, /*#__PURE__*/React__default.createElement("li", {
        className: "str-chat__message-actions-list-item"
      }, "Mute")), messageActions.indexOf(MESSAGE_ACTIONS.edit) > -1 && /*#__PURE__*/React__default.createElement("button", {
        onClick: handleEdit
      }, /*#__PURE__*/React__default.createElement("li", {
        className: "str-chat__message-actions-list-item"
      }, "Edit Message")), messageActions.indexOf(MESSAGE_ACTIONS.delete) > -1 && /*#__PURE__*/React__default.createElement("button", {
...
var Gallery = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default.createElement("p", null, images.length - 3, " more")), /*#__PURE__*/React__default.createElement(ModalGateway, null, this.state.modalIsOpen ? /*#__PURE__*/React__default.createElement(Modal$1, {
        onClose: this.toggleModal,
...
var MessageInputLarge = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(MessageInputLarge, [{
    ...
    value: function render() {
      ...
      }, this.props.watcher_count, " online"), /*#__PURE__*/React__default.createElement("span", {
...
var MessageSimple = /*#__PURE__*/function (_PureComponent) {
  ...
  function MessageSimple() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderStatus", function () {
      ...
      if (message.status === 'sending') {
        ...
        }, /*#__PURE__*/React__default.createElement(Tooltip, null, "Sending..."), /*#__PURE__*/React__default.createElement(LoadingIndicator, null));
        ...
        return /*#__PURE__*/React__default.createElement("span", {
          className: "str-chat__message-simple-status"
        }, /*#__PURE__*/React__default.createElement(Tooltip, null, "Delivered"), /*#__PURE__*/React__default.createElement("svg", {
          width: "16",
          height: "16",
          xmlns: "http://www.w3.org/2000/svg"
        }, /*#__PURE__*/React__default.createElement("path", {
  ...
  _createClass(MessageSimple, [{
    ...
    value: function render() {
      ...
      var when = dayjs(message.created_at).calendar();
      ...
      }, "Error \xB7 Unsent"), message.status === 'failed' && /*#__PURE__*/React__default.createElement("div", {
        className: "str-chat__simple-message--error-message"
      }, "Message Failed \xB7 Click to try again"), unsafeHTML ? /*#__PURE__*/React__default.createElement("div", {
        dangerouslySetInnerHTML: {
          __html: message.html
        }
    ...
    _defineProperty(_assertThisInitialized(_this2), "addToEventHistory", function (e) {
      _this2.setState(function (prevState) {
        ...
        if (!prevState.eventHistory[lastMessageId]) return _objectSpread$4({}, prevState, {
          eventHistory: _objectSpread$4({}, prevState.eventHistory, {
            [lastMessageId]: [e]
          })
        });
  ...
  _createClass(ChannelInner, [{
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        core = /*#__PURE__*/React__default.createElement("div", null, "Channel Missing");
      } else {
...
var ChannelHeader = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(ChannelHeader, [{
    ...
    value: function render() {
      ...
      }, this.props.channel.data.image && /*#__PURE__*/React__default.createElement(Avatar, {
      ...
      }, this.props.title || this.props.channel.data.name, ' ', this.props.live && /*#__PURE__*/React__default.createElement("span", {
        className: "str-chat__header-livestream-left--livelabel"
      }, "live")), this.props.channel.data.subtitle && /*#__PURE__*/React__default.createElement("p", {
        className: "str-chat__header-livestream-left--subtitle"
      }, this.props.channel.data.subtitle), /*#__PURE__*/React__default.createElement("p", {
        className: "str-chat__header-livestream-left--members"
      }, !this.props.live && this.props.channel.data.member_count > 0 && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, this.props.channel.data.member_count, " members, "), this.props.watcher_count, " online")), /*#__PURE__*/React__default.createElement("div", {
...
var EmptyStateIndicator = function EmptyStateIndicator(_ref) {
  ...
  switch (listType) {
    case 'channel':
      Indicator = /*#__PURE__*/React__default.createElement("p", null, "You have no channels currently");
      break;
  ...
  _createClass(ChatDown, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        src: image
      }), /*#__PURE__*/React__default.createElement("h1", null, type), /*#__PURE__*/React__default.createElement("h3", null, text)));
    }
  }]);
...
var DateSeparator = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(DateSeparator, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
      ...
      }, this.props.formatDate ? this.props.formatDate(this.props.date) : dayjs(this.props.date.toISOString()).calendar(null, {
        lastDay: '[Yesterday]',
        sameDay: '[Today]',
        nextDay: '[Tomorrow]',
        lastWeek: '[Last] dddd',
        nextWeek: 'dddd',
        sameElse: 'L'
      })), (position === 'left' || position === 'center') && /*#__PURE__*/React__default.createElement("hr", {
        className: "str-chat__date-separator-line"
      }));
    }
  }]);
  ...
  _createClass(EventComponent, [{
    ...
    value: function render() {
      ...
      if (message.type === 'system') {
        ...
        }, /*#__PURE__*/React__default.createElement("strong", null, dayjs(message.created_at).format('dddd'), " "), "at ", dayjs(message.created_at).format('hh:mm A')));
      }
...
var Message = /*#__PURE__*/function (_Component) {
  ...
  function Message(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "isModerator", function () {
      return _this.props.members && _this.props.members[_this.props.client.user.id] && _this.props.members[_this.props.client.user.id].is_moderator;
    });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                ...
                addNotification(successMessage ? successMessage : "".concat(message.user.name || message.user.id, " has been muted"), 'success');
                _context2.next = 13;
                break;
...
var MessageCommerce = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(MessageCommerce, [{
    ...
    value: function render() {
      ...
      var when = dayjs(message.created_at).format('LT');
      ...
      if (message.deleted_at) {
        ...
        }, "This message was deleted..."), /*#__PURE__*/React__default.createElement("div", {
          className: "clearfix"
        }));
      }
      ...
      }, "Error \xB7 Unsent"), unsafeHTML ? /*#__PURE__*/React__default.createElement("div", {
        dangerouslySetInnerHTML: {
          __html: message.html
        }
      }) : renderText(message), hasReactions && !this.state.showDetailedReactions && /*#__PURE__*/React__default.createElement(ReactionsList, {
  ...
  _createClass(MessageList, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
        ...
        type: "error"
      }, "Connection failure, reconnecting now..."), /*#__PURE__*/React__default.createElement(MessageNotification, {
...
var MessageLivestream = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(MessageLivestream, [{
    ...
    value: function render() {
      ...
      }, dayjs(message.created_at).format('h:mmA')), channelConfig && channelConfig.reactions && /*#__PURE__*/React__default.createElement("span", {
      ...
      }, "Only visible to you")), /*#__PURE__*/React__default.createElement("div", {
...
var MessageTeam = /*#__PURE__*/function (_PureComponent) {
  ...
  function MessageTeam() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderStatus", function () {
      ...
      if (message.status === 'sending') {
        ...
        }, /*#__PURE__*/React__default.createElement(Tooltip, null, "Sending..."), /*#__PURE__*/React__default.createElement(LoadingIndicator, {
          isLoading: true
        }));
      } else if (readBy.length !== 0 && !threadList && !justReadByMe) {
        var lastReadUser = readBy.filter(function (item) {
  ...
  _createClass(MessageTeam, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
      ...
      }, Boolean(Date.parse(message.created_at)) && dayjs(message.created_at).format('h:mmA'))), /*#__PURE__*/React__default.createElement("div", {
        ...
        fill: "#EA152F",
        fillRule: "evenodd"
      })), "Message failed. Click to try again.")), this.renderStatus(), message.text !== '' && hasAttachment && this.renderAttachments(attachments), message.latest_reactions && message.latest_reactions.length !== 0 && message.text === '' && /*#__PURE__*/React__default.createElement(SimpleReactionsList, {
        reaction_counts: message.reaction_counts,
        handleReaction: handleReaction,
        reactions: message.latest_reactions
...
var ThreadInner = /*#__PURE__*/function (_React$PureComponent2) {
  ...
  _createClass(ThreadInner, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default.createElement("strong", null, "Thread"), /*#__PURE__*/React__default.createElement("small", null, this.props.thread.reply_count, " replies")), /*#__PURE__*/React__default.createElement("button", {
        onClick: function onClick(e) {
      ...
      }, "Start of a new thread"), /*#__PURE__*/React__default.createElement(MessageList, _extends({

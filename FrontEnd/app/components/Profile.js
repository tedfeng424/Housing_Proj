...
export default function Profile(){
    ...
    return (
        <div className="col flex-center">
            ...
            <div className="col">
                <img src={cookies["profile_pic"] || "./app/resources/damn.jpeg"} alt="profile" height="100px" style={{marginTop:"50px","border-radius": '80%'}}/>
            ...
            <div className="row">
            <ul style={{textAlign:"right",marginLeft:"52px",marginRight:"25px"}}>
            <li>Last Name:</li>
            <li>First Name:</li>
